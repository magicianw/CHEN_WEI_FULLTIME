...
(cl:in-package path_schedule-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <msg1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_schedule-msg:<msg1> is deprecated: use path_schedule-msg:msg1 instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_schedule-msg:num-val is deprecated.  Use path_schedule-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_schedule-msg:first_name-val is deprecated.  Use path_schedule-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_schedule-msg:last_name-val is deprecated.  Use path_schedule-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_schedule-msg:age-val is deprecated.  Use path_schedule-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_schedule-msg:score-val is deprecated.  Use path_schedule-msg:score instead.")
  (score m))

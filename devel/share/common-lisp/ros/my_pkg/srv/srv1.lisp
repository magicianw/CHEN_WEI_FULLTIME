...
(cl:defmethod cl:initialize-instance :after ((m <srv1-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv1-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pkg-srv:<srv1-request> is deprecated: use my_pkg-srv:srv1-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <srv1-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv1-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pkg-srv:<srv1-response> is deprecated: use my_pkg-srv:srv1-response instead.")))
